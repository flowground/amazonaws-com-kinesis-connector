# ![LOGO](logo.png) Amazon Kinesis MSP Connector

## Description

A generated MSP connector for the Amazon Kinesis API (version 2013-12-02).
...
flowground :- Telekom iPaaS / amazonaws-com-kinesis-connector<br/>
